...
# %%
import os
path_manutenzione = "/content/drive/MyDrive/Manutenzione/"
os.chdir(path_manutenzione)
...
# %store res_val
# %store res_test
# %store hpt_rul_train_scaled
# %store hpc_rul_train_scaled
# %store ww_rul_train_scaled
...
hi_hpt_val = HIE(coefs_hpt, res_val[degradation_vars])
hi_hpc_val = HIE(coefs_hpc, res_val[degradation_vars])
hi_ww_val = HIE(coefs_ww, res_val[degradation_vars])
