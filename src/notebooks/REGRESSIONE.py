...
df_full = pd.concat([dfd, dfm[['esn', 'cycle', 'fault_hpt_cycle', 'to_next_hpt_cycle']]], axis=1)
...
plt.plot(x_axis, final_preds['True_RUL'].values, label='Target Reale', color='black', alpha=0.7, linewidth=1)
plt.plot(x_axis, final_preds['Pred_RUL'].values, label='Predizione LOGO', color='red', linestyle='--', alpha=0.6)
...
# Valori Reali (Target)
plt.plot(x_axis, y_test[target_col].values, label='Reale (Tutti i motori)', color='black', alpha=0.7)

# Predizione PCA
plt.plot(x_axis, y_pred, label='Predizione PCA (Tutti i motori)', color='red', linestyle='--', alpha=0.6)
...
plt.plot(x_axis, y_test[target_col].values, label='Reale (Target)', color='black', alpha=0.8)
plt.plot(x_axis, y_pred_raw, label='Predizione MLR (Senza PCA)', color='green', linestyle='--', alpha=0.7)
...
plt.plot(x_axis, y_test[target_col].values, label='Reale (Target)', color='black', alpha=0.8)
plt.plot(x_axis, y_pred_rf, label='Predizione Random Forest', color='blue', linestyle='--', alpha=0.7)
...
# Predizione RF + PCA
plt.plot(x_axis, y_pred_rf_pca, label='Predizione RF su PCA', color='magenta', linestyle='--', alpha=0.7)
...
plt.plot(x_axis, y_pred_xgb, label='Predizione XGBoost su PCA', color='orange', linestyle='-', alpha=0.7)
