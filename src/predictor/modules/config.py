...
DEGRAD_VARS: List[str] = [
    s for s in SENSORS if s not in OPERATING_VARS and s not in _EXCLUDED_SENSORS
]
...
WW_DYNAMIC_SLOPE_DETECTION: bool = True
...
PLOT_WW_T45_DEFECTED: bool = True
