...
WINDOW_BEFORE_SUBMISSION_HPT: int = 3
WINDOW_BEFORE_SUBMISSION_HPC: int = 3
WINDOW_BEFORE_SUBMISSION_MIN_PERIODS: int = 1
...
WINDOW_BEFORE_WW_PREDICT: int = 10
WINDOW_BEFORE_WW_PREDICT_MIN_PERIODS: int = 1
