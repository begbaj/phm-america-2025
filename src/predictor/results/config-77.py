...
# LGBM GAP CORRECTION
# ──────────────────────────────────────────
GAP_FEATURE_WINDOW: int = 30
GAP_ROLLING_WINDOWS: List[int] = [10, 20, 50]
GAP_RANGE_WINDOWS: List[int] = [20, 50]
GAP_ACCEL_WINDOW: int = 20
GAP_SENSOR_SLOPE_WINDOW: int = 20
GAP_PREDICTED_CYCLE_ONLY: bool = True
GAP_DROP_CONSTANT_FEATURES: bool = True
...
# Optional LightGBM early-stopping (reduces runtime and overfit)
LGBM_USE_EARLY_STOPPING: bool = True
LGBM_EARLY_STOPPING_ROUNDS: int = 200
LGBM_VALID_FRACTION_BY_ESN: float = 0.2

# Windowing applied only on test predictions before submission writing
APPLY_WINDOW_BEFORE_SUBMISSION: bool = True
WINDOW_BEFORE_SUBMISSION_HPT: int = 25
WINDOW_BEFORE_SUBMISSION_HPC: int = 25
WINDOW_BEFORE_SUBMISSION_MIN_PERIODS: int = 3

# ──────────────────────────────────────────
# WW PREDICTION
# ──────────────────────────────────────────
WW_DETECTION_WINDOW: int = 1
WW_FACTOR_MULT: int = 80
WW_USE_TRAINING_MEAN_SLOPE: bool = True

# Windowing applied to WW signal before predict_ww logic
APPLY_WINDOW_BEFORE_WW_PREDICT: bool = True
WINDOW_BEFORE_WW_PREDICT: int = 25
WINDOW_BEFORE_WW_PREDICT_MIN_PERIODS: int = 3
...
# ──────────────────────────────────────────
# PHM / PROGNOSTICS DIAGNOSTICS
# ──────────────────────────────────────────
PRINT_HI_PROGNOSTIC_METRICS: bool = True
